document.getElementById("table-gridjs") &&
  new gridjs.Grid({
    columns: [
      ...
      { name: "Instance Name", width: "150px" },
      {
        name: "Username",
        width: "220px",
        formatter: function (e) {
      ...
      { name: "Create Date", width: "180px" },
      { name: "Expire Date", width: "180px" },
      {
        name: "Actions",
        width: "150px",
        formatter: function (e) {
  ...
  document.getElementById("table-card") &&
    new gridjs.Grid({
      columns: [
        { name: "Instance ID", width: "150px" },
        { name: "Instance Name", width: "250px" },
        { name: "Username", width: "250px" },
        { name: "Email", width: "250px" },
        { name: "Create Date", width: "150px" },
        { name: "Expire Date", width: "150px" },
      ],
      sort: !0,
      pagination: { limit: 5 },
      data: [
